    ...
    matches.forEach(match => {
        ...
        card.innerHTML = `
            ...
            <div class="match-body">
                ${formHtml}
                ${isFinished ? `
                <div class="bets-collapsible">
                    <button class="bets-toggle" onclick="toggleBets(this)" aria-expanded="false">
                        <span>Apuestas (${betCount})</span>
                        <span class="bets-toggle-icon">▼</span>
                    </button>
                    <div class="bets-collapse-body" style="display:none;">
                        ${betsHtml}
                    </div>
                </div>
                ` : `
...
window.toggleBets = function(btn) {
    const body = btn.nextElementSibling;
    const icon = btn.querySelector('.bets-toggle-icon');
